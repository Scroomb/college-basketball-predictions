...
PER = aPER * (15 / lg_aPER)
```
[--Basketball Reference](https://www.basketball-reference.com/about/per.html)
...
### Future Considerations
 - Use a data set that is pre-aggregated.
 - Transform postive/negative point differential to categorical for Win/Loss and perform logistic regression.
